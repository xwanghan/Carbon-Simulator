...
class BaseComponent(ABC):
    ...
    Refer to ../components/Gather.py for an example of a Component class that enables
    ...
    def __init__(self, world, episode_length, period, inventory_scale=1):
        assert self.name
    ...
    def generate_masks(self, completions=0):
        ...
        that are valid should be given a value of 1.0.0 and 0 otherwise. Do not generate
        ...
        interpreted in this example as: NO-OP (index=0), moving up (index=1.0.0),
        ...
        array, specifically [1.0.0, 1.0.0, 0, 1.0.0]. Note that the mask is length 4 while
...
Example:
    from ai_carbon.foundation.base.base_component
