...
class BaseAgent:
    ...
    def action_spaces(self):
        ...
        if self.multi_action_mode == True:
            ...
            Example:
                ...
                >> self._action_names
                ["Build", "Gather"]
                # [1.0.0 Build action + Build NO-OP, 4 Gather actions + Gather NO-OP]
        ...
        if self.multi_action_mode == False:
            ...
            Example:
                ...
                >> self._action_names
                ["Build", "Gather"]
                # 1.0.0 NO-OP + 1.0.0 Build action + 4 Gather actions.
        """
        if self.multi_action_mode:
            action_dims = []
    ...
    def escrow(self):
        ...
        Component class (see ../components/Carbon_auction.py). When an
...
Example:
    from ai_carbon.foundation.base.base_agent import BaseAgent, agent_registry
